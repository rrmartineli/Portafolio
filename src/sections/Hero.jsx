    ...
    <section className="flex items-center justify-center px-6 py-8 md:pt-24 md:pb-0">
      <div className="max-w-7xl w-270 grid grid-cols-1 md:grid-cols-5 gap-5 auto-rows-[130px]">
        ...
        <motion.div
          ...
          whileHover={{ y: -5 }}
          className="group relative md:col-span-2 md:row-span-2 bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-[20px] p-10 backdrop-blur-xl flex flex-col items-center justify-center text-center overflow-hidden hover:border-blue-500/30 hover:shadow-[0_0_50px_rgba(59,130,246,0.15)] transition-all duration-500"
        >
          ...
          <div className="relative mb-8">
            ...
            <div className="relative w-24 h-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-6xl shadow-2xl backdrop-blur-sm">
              👨🏽‍💻
            </div>
          </div>
        ...
        <motion.div
          ...
          className="group relative md:col-span-2 bg-gradient-to-br from-white/10 to-white/5 border border-white/10 hover:border-blue-500/30 hover:shadow-[0_0_45px_rgba(59,130,246,0.18)] rounded-[20px] p-10 flex items-center text-left overflow-hidden "
        >
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-br from-blue-500/10 via-transparent to-purple-500/10 pointer-events-none" />
          <p className="relative z-10 text-base md:text-base leading-[1.4] font-normal tracking-normal text-zinc-200 antialiased">
            Desarrollador de Software con experiencia en el <span className="text-white font-medium">diseño</span>, <span className="text-white font-medium">desarrollo</span> e <span className="text-white font-medium">integración</span> de aplicaciones multiplataforma.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="group relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 border border-white/10 hover:border-blue-500/30 hover:shadow-[0_0_45px_rgba(59,130,246,0.18)] rounded-[20px] flex items-center justify-center cursor-pointer"
        >
          <motion.div 
